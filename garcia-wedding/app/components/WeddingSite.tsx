...
const HOTELS: Hotel[] = [
  ...
  { name: 'Marquis de Lafayette', frame: 20, logo: 'marquis', price: '$$',
    details: [
      <>Click &ldquo;Group Login&rdquo; and enter the Group Code.</>,
    ...
    >
      ...
      <SectionShell id="dress" tone="cream">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }} className="pair-grid">
          ...
          <Tile tone="cream" heading="Mass & Reception" body={<>Black-tie Optional<br/><br/>We ask that ladies wear a floor-length dress. Bright, summery colors and patterns are encouraged. For gentlemen, a black tuxedo or dark suit is preferred. The reception is fully outdoors on grass; block heels are strongly recommended.</>} />
        </div>
      </SectionShell>
      ...
      */}
      ...
      <SectionShell id="faq" tone="pattern">
        <Title>FAQ</Title>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {/* Grouped: who's coming -> where to stay -> what to wear -> where to eat
              -> day-of logistics, so related questions sit together */}
          ...
          <FaqRow q='Where is a good spot to grab dinner on Thursday?' a='Please check out the To-Do section for our local favorites. We highly recommend making a reservation in advance.' />
